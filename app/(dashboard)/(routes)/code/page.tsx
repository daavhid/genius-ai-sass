...
import { Code, LucideRefreshCw, MessageSquare, RefreshCcw, RefreshCcwIcon } from 'lucide-react'
                        ...
                        <FormItem className='col-span-12 md:col-span-10'>
                            <FormControl>
                                <Input className='border-0 outline-none focus-visible:ring-0 focus-visible:ring-transparent placeholder-shown:text-xs '
                                 placeholder='a react code for a simple calculator ...' {...field} disabled={isLoading}/>
                            </FormControl>
                        </FormItem>
                    )}/>
